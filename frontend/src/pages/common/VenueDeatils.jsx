    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gray-100 hover:bg-blue-500 hover:text-white cursor-pointer text-gray-800 py-2 px-4 rounded-md transition duration-200"
        >
          <svg
