...
const VenueDetailsPage = () => {
  ...
  const getServiceIcon = (serviceName) => {
    ...
    if (name.includes("dj") || name.includes("music"))
      return <Music className="mr-2 text-teal-500" size={20} />;
    if (name.includes("catering") || name.includes("food"))
      return <Utensils className="mr-2 text-teal-500" size={20} />;
    if (name.includes("photo") || name.includes("video"))
      return <Camera className="mr-2 text-teal-500" size={20} />;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="rounded-lg overflow-hidden shadow-md">
              <img
                src={
                  getOptimizedCloudinaryUrl(venue.image?.secure_url) ||
                  "/placeholder.svg"
                }
                alt={venue.name}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                ...
                <p className="text-gray-700">
                  <span className="mr-1">Rs.</span> {venue.basePricePerHour} per
                  hour
                </p>
              </div>
            </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 flex items-center mt-1">
                          <IndianRupee
                            ...
                            size={14}
                          />{" "}
                          Rs. {service.servicePrice} {/* Teal rupee icon */}
                        </p>
                      </div>
                    </div>
                  ))}
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              ...
              {venue.owner.phone && (
                <p className="flex items-center text-gray-700">
                  <Phone className="mr-2 text-teal-500" size={20} />{" "}
                  {venue.owner.phone}
                </p>
              )}
            </div>
